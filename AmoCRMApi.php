<?php
	...
	$user = array(
		'USER_LOGIN' => 'teo@zavidov.realty', #Ваш логин (электронная почта)
		'USER_HASH' => 'e4de44d0315786800bbe997baa0fba9ab3df0927', #Хэш для доступа к API (смотрите в профиле пользователя)
	);
	$subdomain = 'zavidov'; #Наш аккаунт - поддомен
